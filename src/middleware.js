...
export async function middleware(request) {
  ...
  if (request.nextUrl.pathname === '/') {
    ...
    const csp = `
      ...
      connect-src 'self' wss: ws: https://www.google-analytics.com https://region1.google-analytics.com https://challenges.cloudflare.com https://maps.googleapis.com https://cloudflareinsights.com;
