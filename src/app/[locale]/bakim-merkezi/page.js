      ...
      <section className="container mx-auto px-4 max-w-6xl pb-20">
        ...
        <div className="mt-16 glass-panel p-8 border border-white/5 rounded-2xl max-w-2xl mx-auto">
          ...
          <form onSubmit={(e) => {
            ...
            <select name="brand" required className="flex-1 bg-white/5 border border-white/10 p-4 rounded-xl text-white outline-none focus:border-[var(--accent-gold)]">
              <option value="" disabled selected>Marka Seçin</option>
              <option value="bmw">BMW</option>
              <option value="mercedes">Mercedes-Benz</option>
              <option value="audi">Audi</option>
            </select>
            <select name="mileage" required className="flex-1 bg-white/5 border border-white/10 p-4 rounded-xl text-white outline-none focus:border-[var(--accent-gold)]">
              <option value="" disabled selected>Kilometre</option>
