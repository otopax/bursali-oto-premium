...
export async function generateMetadata({ params }) {
  ...
  return buildSEOContract({
    locale,
    path: '/teknik-kutuphane',
    title: 'Araç Teknik Kütüphanesi ve Servis Kılavuzları | Bursalı Oto Servis',
    description: 'Tüm araç markaları için sigorta kutusu diyagramları ve orijinal teknik servis kılavuzları bilgi bankası.'
  });
}
