...
export async function generateMetadata({ params }) {
  ...
  return buildSEOContract({
    locale,
    path: '/sigorta-kutuphanesi',
    title: 'Sigorta Kutusu ve Röle Şemaları Kütüphanesi | Bursalı Oto Servis Fethiye',
    description: 'Tüm araç markalarının detaylı sigorta kutusu diyagramları, röle şemaları ve amper değerleri rehberi.'
  });
}
