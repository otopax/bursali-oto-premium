      ...
      <footer style={{ padding: '3rem 0', textAlign: 'center', borderTop: '1px solid var(--glass-border)' }}>
        <div className="container">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem', margin: '1.5rem 0', flexWrap: 'wrap' }}>
            <a href={`/${locale}/hakkimizda`} style={{ color: 'var(--text-light)', textDecoration: 'none' }}>{t('footerAbout')}</a>
            <a href={`/${locale}/seffaf-fiyatlandirma`} style={{ color: 'var(--text-light)', textDecoration: 'none' }}>{t('footerPricing')}</a>
            <a href={`/${locale}/ariza-cozumleri`} style={{ color: 'var(--text-light)', textDecoration: 'none' }}>{t('footerFaults')}</a>
          </div>
